...
<template>
  <div class="estilo">
    <ComboboxRoot v-model="values" v-model:search-term="searchTerm" multiple class="my-4 mx-auto relative">
      <ComboboxAnchor
        ...
        <TagsInputRoot v-slot="{ modelValue: tags }" v-model="values" delimiter=""
